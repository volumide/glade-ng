...
@section('content')
    ...
    <div
        ...
        <div class="flex justify-center px-5  -mt-12">
            ...
            @if ($data->logo)
                <img class="h-32 w-32 bg-white p-2 rounded-full   " src="{{ $data->logo }}" alt="" />
            @else
        ...
        <div class=" ">
            ...
            <div class="flex  bg-gray-50 ">
                <div class="text-center w-1/2 p-4 hover:bg-gray-100 cursor-pointer">
                    <p><span class="font-semibold"> Creator : </span> {{ $data->admin->name }}</p>
                </div>
                <div class="border"></div>
                <div class="text-center w-1/2 p-4 hover:bg-gray-100 cursor-pointer">
                    <p> <span class="font-semibold">Creator role: </span> {{ $data->admin->role ? 'Super admin' : 'admin' }}
                    </p>
                </div>
