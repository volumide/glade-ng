...
@section('content')
    <form action="/company/login" method="POST" class="pb-10 shadow-md mt-5 rounded overflow-hidden lg:w-2/5 mx-auto">
        @csrf
        <h1 class="text-2xl text-center mb-10 bg-gray-800 py-5  text-white font-bold">Company Login Page </h1>
