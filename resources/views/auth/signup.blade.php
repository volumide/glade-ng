...
@section('content')
    <form action="/company/register" method="POST" class="pb-10 shadow-md mt-5 rounded overflow-hidden lg:w-2/5 mx-auto"
        ...
        <div class="w-full px-4">
            <div class="mb-5">
                ...
                <input type="text" placeholder="Default Input" name="name" value="{{ @old('name') }}"
        ...
        <div class="w-full px-4">
            <div class="mb-5">
                ...
                <input type="email" placeholder="Default Input" name="email" value="{{ @old('email') }}"
                    class=" w-full border-[1.5px] border-form-stroke rounded-lg py-3 px-5 font-medium text-body-color placeholder-body-color outline-none focus:border-primary active:border-primary transition disabled:bg-[#F5F7FD] disabled:cursor-default">
                @error('email')
                    <p class="text-red-400">{{ $message }}</p>
                @enderror
        ...
        <div class="w-full  px-4">
            <div class="mb-5">
                ...
                <input type="text" placeholder="Default Input" name="website" value="{{ @old('wwebsite') }}"
                    class=" w-full border-[1.5px] border-form-stroke rounded-lg py-3 px-5 font-medium text-body-color placeholder-body-color outline-none focus:border-primary active:border-primary transition disabled:bg-[#F5F7FD] disabled:cursor-default">
            </div>
        </div>
        <div class="w-full  px-4">
